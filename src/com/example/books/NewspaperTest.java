...
class NewspaperTest {
    ...
    void getName() {
        ...
        Newspaper b = new Newspaper(1,"Белоснежка", 2001, 100, 1, 11, 1,0);
    ...
    void getParent() {
        ...
        new Category( 11,"Сказки зарубежные добрые", 0);
        new Publisher(1, "Семечко", 60);
        Newspaper b = new Newspaper(6, "Вестник", 2018,10,1,11, 1,0);
        Article b2 = new Article(9, "Что произошло на этой недели ", 2018,3,1,11, 1,6);
    ...
    void calcPrice2Newspaper() {
        ...
        new Publisher(1, "Семечко", 60);
        Newspaper b = new Newspaper(1,"Белоснежка", 2001, 100, 1, 11, 1,0);
        Newspaper b2 = new Newspaper(2,"Белоснежка", 2001, 70, 1, 11, 1,1);
    ...
    void calcPrice3Newspaper() {
        ...
        new Publisher(1, "Семечко", 60);
        Newspaper b = new Newspaper(1,"Белоснежка", 2001, 100, 1, 11, 1,0);
        Newspaper b2 = new Newspaper(2,"Белоснежка", 2001, 100, 1, 11, 1,1);
        Newspaper b3 = new Newspaper(3,"Белоснежка", 2001, 100, 1, 11, 1,1);
    ...
    void calcPrice4Newspaper() {
        ...
        Newspaper b2 = new Newspaper(2,"Белоснежка", 2001, 100, 1, 11, 1,1);
        Newspaper b3 = new Newspaper(3,"Белоснежка", 2001, 100, 1, 11, 1,1);
        Newspaper b4 = new Newspaper(4,"Белоснежка", 2001, 100, 1, 11, 1,3);
        Newspaper b5 = new Newspaper(5,"Белоснежка", 2001, 100, 1, 11, 1,3);
